                    ...
                    <br><br>
                      <div class="flex-container">
                          <div class="skills-container">
                              ...
                              <div class="list">
                                Vanilla JavaScript and VueJS experience<br>
                          ...
                          <div class="skills-container">
                              ...
                              <div class="list">
                                I have experience building express CRUD APIs, interfacing with MongoDB and including user authentication, login, signup.<br><br>
                              </div>
                          </div>
                          <!-- <div class="skills-container">
                              <img
